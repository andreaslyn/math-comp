...
Module GroupSet.
Monomorphic Definition sort (gT : baseFinGroupType) := {set gT}.
End GroupSet.
Identity Coercion GroupSet_of_sort : GroupSet.sort >-> set_of.

Module Type GroupSetBaseGroupSig.
Monomorphic Definition sort gT := group_set_of_baseGroupType gT : Type.
...
refine (transport (fun Z:{set gT} => (_ \subset Z) && _) (mulGid _) _).
